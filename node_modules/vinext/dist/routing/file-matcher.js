...
export function normalizePageExtensions(pageExtensions) {
...
export function buildExtensionGlob(stem, extensions) {
 ...
 */
export function createValidFileMatcher(pageExtensions) {
