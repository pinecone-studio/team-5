 ...
 */
export declare function getDotenvFiles(mode: VinextEnvMode): string[];
/**
 ...
 */
export declare function loadDotenv({ root, mode, processEnv, }: LoadDotenvOptions): LoadDotenvResult;
