...
export function useSearchParams() {
    ...
    return React.useSyncExternalStore((cb) => { _listeners.add(cb); return () => { _listeners.delete(cb); }; }, getSearchParamsSnapshot, getServerSearchParamsSnapshot);
}
/**
