...
const clientReferences = {
  "4e0f6d814d0a": async () => {
    const m = await import("./assets/worker-entry-yZ6YZS_9.js");
    return m.export_4e0f6d814d0a;
  },
  "53dd1aee8801": async () => {
    const m = await import("./assets/worker-entry-yZ6YZS_9.js");
    return m.export_53dd1aee8801;
  },
  "5ddc6576b3df": async () => {
    const m = await import("./assets/worker-entry-yZ6YZS_9.js");
    return m.export_5ddc6576b3df;
  },
  "24cb8e9c331f": async () => {
    const m = await import("./assets/worker-entry-yZ6YZS_9.js");
    return m.export_24cb8e9c331f;
  },
  "9ca600a341ea": async () => {
    const m = await import("./assets/worker-entry-yZ6YZS_9.js");
    return m.export_9ca600a341ea;
  },
  "7f021d8d18ff": async () => {
    const m = await import("./assets/worker-entry-yZ6YZS_9.js");
    return m.export_7f021d8d18ff;
  },
  "fd4beb67413a": async () => {
    const m = await import("./assets/worker-entry-yZ6YZS_9.js");
    return m.export_fd4beb67413a;
  },
  "f58fa8f11e7a": async () => {
    const m = await import("./assets/worker-entry-yZ6YZS_9.js");
    return m.export_f58fa8f11e7a;
  },
  "090187722cdc": async () => {
    const m = await import("./assets/worker-entry-yZ6YZS_9.js");
    return m.export_090187722cdc;
  },
  "f5ab0c789fe8": async () => {
    const m = await import("./assets/worker-entry-yZ6YZS_9.js");
    return m.export_f5ab0c789fe8;
  },
  "687152673e36": async () => {
    const m = await import("./assets/worker-entry-yZ6YZS_9.js");
    return m.export_687152673e36;
  },
  "f29e6e234fea": async () => {
    const m = await import("./assets/worker-entry-yZ6YZS_9.js");
...
function getPrefetchCache() {
  ...
  if (!window.__VINEXT_RSC_PREFETCH_CACHE__) {
    window.__VINEXT_RSC_PREFETCH_CACHE__ = /* @__PURE__ */ new Map();
  }
...
function getPrefetchedUrls() {
  ...
  if (!window.__VINEXT_RSC_PREFETCHED_URLS__) {
    window.__VINEXT_RSC_PREFETCHED_URLS__ = /* @__PURE__ */ new Set();
  }
...
export {
  ...
  handleSsr,
  toRscUrl as i,
  getPrefetchedUrls as j,
  getLayoutSegmentContext as k,
  reactExports as r,
  storePrefetchResponse as s,
  toSameOriginPath as t,
