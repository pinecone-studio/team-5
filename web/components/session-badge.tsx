...
export default function SessionBadge({
  ...
  if (!isLoaded) {
    return <div className="h-8 w-28 rounded-md bg-gray-100" />;
  }
      ...
      {open ? (
        ...
        >
          <div className="border-b border-gray-100 px-3 py-2">
            ...
            <p className="mt-1 inline-flex rounded-md bg-gray-100 px-2 py-0.5 text-[11px] font-medium uppercase tracking-wide text-gray-600">
              {role}
            </p>
          </div>
          <SignOutButton redirectUrl="/">
            <button
              type="button"
              className="mt-2 flex w-full items-center gap-2 rounded-lg px-3 py-2 text-sm text-gray-700 transition hover:bg-gray-100 hover:text-gray-900"
              role="menuitem"
            >
