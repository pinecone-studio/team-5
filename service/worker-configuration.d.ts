/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: f23f0ec5a3e3e1e566907cdbec70f5ea)
...
declare namespace Cloudflare {
	...
	interface Env {
		DB: D1Database;
		CLERK_PUBLISHABLE_KEY: "pk_test_Ymxlc3NlZC1wcmltYXRlLTc0LmNsZXJrLmFjY291bnRzLmRldiQ";
		FRONTEND_ORIGIN: "https://web.ebmsteam10.workers.dev";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CLERK_PUBLISHABLE_KEY" | "FRONTEND_ORIGIN" | "NEXT_PUBLIC_CLERK_PUBLISHABLE_KEY" | "CLERK_SECRET_KEY" | "NEXT_PUBLIC_GRAPHQL_URL" | "NEXT_PUBLIC_BASE_URL">> {}
}
